...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 76a9f41a-be9c-45fe-8f9a-d97d752514ff
```

> `76a9f41a-be9c-45fe-8f9a-d97d752514ff` is the password of the certificate, you can change it to any password you want.
